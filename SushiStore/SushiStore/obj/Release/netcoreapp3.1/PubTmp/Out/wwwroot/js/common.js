...
//Mobile Call
    ...
    $(document).on('click', '.sticky-menu-btn', function (e) {
        ...
        $("html, body").animate({
            scrollTop: parseInt($(".menu_section").position().top) - 40
        }, 20);
    ...
    $(document).on('click', '.del-btn.cart-del-btn', function (e) {
        ...
        console.log(pr_price, productCount, pr_price, total_price, circlecount);
        ...
        $('#callback-request').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    setTimeout(() => { $(".modal").removeClass('open'); }, 900);
