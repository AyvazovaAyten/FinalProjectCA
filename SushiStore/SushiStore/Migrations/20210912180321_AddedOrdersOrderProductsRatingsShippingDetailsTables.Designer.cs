...
namespace SushiStore.Migrations
{
    ...
    [Migration("20210912180321_AddedOrdersOrderProductsRatingsShippingDetailsTables")]
    partial class AddedOrdersOrderProductsRatingsShippingDetailsTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SushiStore.Models.ShippingDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SushiStore.Models.ShippingDetail", b =>
                {
                    b.HasOne("SushiStore.Models.Order", "Order")
                        .WithOne("Shipping")
                        .HasForeignKey("SushiStore.Models.ShippingDetail", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
