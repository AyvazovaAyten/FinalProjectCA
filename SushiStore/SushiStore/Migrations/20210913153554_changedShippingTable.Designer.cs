...
namespace SushiStore.Migrations
{
    ...
    [Migration("20210913153554_changedShippingTable")]
    partial class changedShippingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SushiStore.Models.Order", b =>
                {
                    b.HasOne("SushiStore.Models.ShippingDetail", "Shipping")
                        .WithOne("Order")
                        .HasForeignKey("SushiStore.Models.Order", "ShippingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
